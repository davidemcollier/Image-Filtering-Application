...
public enum ConsoleColour { //ANSI escape codes. These make the UI look a little more presentable.
	...
	//Method to format all invalid inputs
	...
	//Method to format all errors
	public static void errorFormatter(String error) {
		System.out.println(ConsoleColour.RED_BOLD); 
		System.out.println(error);
		System.out.println(ConsoleColour.RESET);
	}
	//Info format
	public static void infoFormatter(String info) {
